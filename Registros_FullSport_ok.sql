...
insert into productos values('n0001', 'proteina whey', 55000, 100, 'insert img', 'womfit', 'proteina en polvo', 500, 'N/A', 'N/A')
insert into productos values('n0002', 'almendras importadas', 33000, 12, 'isert img', 'grand', 'frutos secos', 340, 'N/A', 'N/A')
insert into productos values('w0001', 'camiseta mujer', 25000, 12, 'isert img', 'nike', 'N/A', 025, 'azul', 'xs')
insert into productos values('g0001', 'mancuernas', 34000, 6, 'insert img', 'smartfit', 'N/A', 1000, 'negro', 'N/A')
insert into productos values('g0002', 'cuerda saltos', 28500, 24, 'insert img', 'smartfit', 'N/A', 087, 'rosa', 'm')

select * from pedidos
insert into pedidos values('p100', '2024-02-01')
insert into pedidos values('p101', '2024-02-02')
insert into pedidos values('p102', '2024-02-03')
insert into pedidos values('p103', '2024-02-04')
insert into pedidos values('p104', '2024-02-05')
